...
export const SearchControls = () => {
    ...
    const activeAccordionTab = searchParams.get('active-accordion') ?? '';
        ...
        <>
            <div className="flex flex-col lg:flex-row gap-4 mb-8">
                ...
                <div className="flex gap-2">
                    <Button
                        variant={
                            activeAccordionTab === 'advanced-filters' ? 'default' : 'outline'
                        }
                        className="h-12"
                        onClick={() => {
                            console.log(activeAccordionTab);
            ...
            {/* Advanced Filters */}
            <Accordion type="single" collapsible value={activeAccordionTab} data-testid="accordion">
